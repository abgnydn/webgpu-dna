...
| SSB direct / indirect / DSB @ 10 keV (**production, v0.6.0 full cascade**) | 32 / 81 / 17      | indirect/direct ratio PARTRAC = 2-3         | **2.53 ratio** (held in-band with the full cascade, no recalibration [E25]; was 2.32 pre-cascade). ⚠ ratio is still a **calibrated fit** (`P_indirect` tuned). Absolute yields per *local* dose: SSB 0.34–1.28× / DSB 0.82× exp (C=991 exact, [E12-local-exact]) [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) [[E12-local-exact]](./experiments/results/2026-06-08/level-5/E12-local-exact.json) |
