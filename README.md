...
| E5b  | ✗ honest negative | **CSDA across all 8 ESTAR energies (NEW 2026-05-12, PRE joint-fix)** — ratio grows monotonically: **0.587× @ 100 eV → 0.992× @ 20 keV** (0.705 / 0.776 / 0.864 / 0.965 / 0.975 / 0.988 / 0.992× at 300/500/1000/3000/5000/10000/20000 eV). The 0.988× @ 10 keV in E5 is the *tail* of a much larger sub-keV deficit driven by σ_exc inflation. Joint-fix CSDA at 100 eV measured separately in E10i: 0.74× (substantial improvement, not yet re-validated at all 8 energies). | [E5b](./experiments/results/2026-05-12/level-2/E5b-csda-multi-energy.json) |
| E5c  | ✗ honest negative | **W-value vs ICRU 31 (NEW 2026-05-12)** — W_cascade = 26.89 eV vs ICRU 31's 21.4 eV → 1.257× (+25.7%). Same physics as E7's 27% cascade-ion deficit, different framing: W = E_total / N_ions, so fewer ions → higher W. | [E5c](./experiments/results/2026-05-12/level-2/E5c-w-value.json) |
