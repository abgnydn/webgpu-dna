...
| E15b | ✓ (v0.5.0 truncated; see E15d) | Same-machine vs Geant4 11.4.1 single-thread (3 trials, M2 Pro): **455×** physics tracking (Phase A+B 635 ms vs Geant4 median 289.1 s) — **but this compared our v0.5.0 truncated cascade to Geant4's full cascade**; v0.6.0's full cascade is **~241×** (fair, [E15d]). WGSL is dispatch-only vs G4 whole-process; init is a measured ~2 s; the real asymmetry is G4's 6.8 GB ntuple I/O. **End-to-end like-for-like is 1.48×** (IRT chem on CPU dominates). | [E15b](./experiments/results/2026-05-11/level-6/E15b-vs-geant4-single-thread.json) |
...
| Ions / primary (full cascade) — **production (v0.6.0, full electron cascade)** | 474.0 | 509.2 (Geant4) | **0.931× (7% deficit)** [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) — tracking the tertiary (gen3+) electron cascade recovers it (was 0.766×). Primary track is **bit-exact** (195.4 vs Geant4 195.6, [[E20]](./experiments/results/2026-06-08/level-2/E20-ion-split.json)); the old 23% deficit was 80% the untracked tertiary cascade ([[E21]](./experiments/results/2026-06-08/level-2/E21-cascade-generations.json)) |
...
| G(OH) @ 1 μs vs chem6 — **production (v0.6.0, full cascade)** | 1.608            | 1.710                                       | **0.940×** [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) (was 0.914× pre-cascade) |
...
| G(e⁻aq) @ 1 μs vs chem6 — **production (v0.6.0, full cascade)** | 1.498            | 1.694                                       | **0.887×** [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) (was 0.858× pre-cascade) |
...
| G(H) @ 1 μs vs chem6 — **production (v0.6.0, full cascade)** | 0.770            | 0.710                                       | **1.085×** [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) (slight overshoot; was 0.928× pre-cascade) |
| G(H₂) @ 1 μs vs chem6 — **production (v0.6.0, full cascade)** | 0.618            | 0.622                                       | **0.993×** [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) — the long-standing H₂ deficit (0.741×) is **closed** by the tertiary cascade |
| G(H₂O₂) @ 1 μs vs chem6 — **production (v0.6.0, full cascade)** | 0.788            | 0.850                                       | **0.927×** [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) — the H₂O₂ deficit (0.693×) largely closed |
...
| SSB direct / indirect / DSB @ 10 keV (**production, v0.6.0 full cascade**) | 32 / 81 / 17      | indirect/direct ratio PARTRAC = 2-3         | **2.53 ratio** (held in-band with the full cascade, no recalibration [E25]; was 2.32 pre-cascade). ⚠ ratio is still a **calibrated fit** (`P_indirect` tuned) — but it is **robust to the target geometry**: a 4× fibre-spacing sweep (75→300 nm) holds the ratio at 2.24–2.53, all in-band, while absolute counts scale ~4× [[E27]](./experiments/results/2026-06-09/level-5/E27-ssb-geometry-sensitivity.json). Absolute yields per *local* dose: SSB 0.34–1.28× / DSB 0.82× exp (C=991 exact, [E12-local-exact]) [[E25]](./experiments/results/2026-06-08/level-4/E25-tertiary-cascade-CLEAN-WIN.json) [[E12-local-exact]](./experiments/results/2026-06-08/level-5/E12-local-exact.json) |
