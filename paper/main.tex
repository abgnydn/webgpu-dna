...
it (ions $0.766\to0.931\times$) and, importantly, \emph{also} closes most of the
residual \SI{1}{\micro s} chemistry gap against \texttt{chem6} (five-species RMS
$19.7\to7.6\,\%$; the $\mathrm{H_2}$/$\mathrm{H_2O_2}$ deficits close)---revising
...
(ions $0.766\to0.931\times$ vs.\ Geant4) and, far from costing accuracy,
\emph{improves} the chemistry to a five-species RMS of $7.6\,\%$ vs.\ chem6
...
\texttt{SIGMA\_EXC\_SCALE}$=0.5$, is a documented physics-data divergence
...
(median $0.941$, E6). In production (v0.6.0) the full-cascade ionisation count
is \num{474.0} per primary vs.\ Geant4's \num{509.2}---a 7\,\% deficit (E25),
...
recovers cascade ions $0.766\to0.931\times$ and, far from costing accuracy,
