...
# ---- Fig 3: G(t) WebGPU vs chem6 1us targets  [IRT cache + chem6 §Numbers] ----
t = [1e-4, 1e-3, 1e-2, 0.1, 1, 10, 100, 1000]
G = {"OH": [4.128,4.114,4.029,3.685,2.976,2.307,1.848,1.531],
     "e$^-_{aq}$": [3.335,3.328,3.292,3.144,2.796,2.279,1.764,1.379],
     "H": [1.003,1.001,0.990,0.941,0.859,0.823,0.802,0.778],
     "H$_2$": [0.197,0.198,0.204,0.225,0.276,0.361,0.458,0.537],
     "H$_2$O$_2$": [0.041,0.045,0.070,0.164,0.355,0.498,0.557,0.589]}
